  ...
  <div>
    ...
    <div class="formRow">
      <div class="formRowItem">
        ...
        <el-input class="nameInput rowInput" v-model="propsData.describeText" :placeholder="placeholderObj.describeText"></el-input>
      </div>
    </div>
    <div class="formRow">
      <div class="formRowItem">
    ...
    <div class="formRow">
      <div class="formRowItem">
        ...
        <el-input class="nameInput rowInput" v-model="propsData.saleNum" :placeholder="placeholderObj.saleNum"
    ...
    <div class="formRow">
      <div class="formRowItem">
        ...
        <el-input class="nameInput rowInput" v-model="propsData.preferencePrice" :placeholder="placeholderObj.preferencePrice"></el-input>
      </div>
    </div>
