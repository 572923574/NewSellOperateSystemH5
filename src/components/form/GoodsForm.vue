    ...
    <div>
        ...
        <div class="formRow">
            <div class="formRowItem">
                ...
                <el-select class="nameInput rowInput" v-model="propsData.type" :placeholder="placeholderObj.type">
                    <el-option v-for="type in goodsTypeList" :key="type.id" :label="type.typeName" :value="type.id">
                    </el-option>
                </el-select>
            </div>
        </div>
        <div class="formRow">
            <div class="formRowItem">
                ...
                <el-select class="nameInput rowInput" v-model="propsData.son_type" :placeholder="placeholderObj.son_type">
                    <el-option v-for="item in goodsSubTypeList" :key="item.id" :label="item.subTypeName" :value="item.id">
                    </el-option>
                </el-select>
            </div>
        </div>
        <div class="formRow">
            <div class="formRowItem">
                ...
                <el-input class="nameInput rowInput" v-model="propsData.num" :placeholder="!!propsData.id?placeholderObj.num:placeholderObj.numStart"
                    :disabled="!!propsData.id"></el-input>
            </div>
        </div>
        <div class="formRow">
            <div class="formRowItem">
        ...
        <div class="formRow">
            <div class="formRowItem">
                ...
                <el-select class="nameInput rowInput" v-model="propsData.goodsCompanyId" :placeholder="placeholderObj.goodsCompanyId">
                    <el-option v-for="item in goodsCompanyList" :key="item.value" :label="item.label" :value="item.value">
                    </el-option>
                </el-select>
            </div>
        </div>
        ...
        <div class="formRow">
            <div class="formRowItem">
                ...
                <el-upload class="upload-demo" action="http://localhost:8080/mts-spa/spa/upload/photo" :on-preview="handlePreview"
