<template>
  ...
  <section>
    ...
    >
      ...
      <el-table-column prop="totalNum" label="优惠劵总数量" width="100" sortable></el-table-column>
      <el-table-column prop="oddNum" label="优惠券剩余数量" width="100" sortable></el-table-column>
